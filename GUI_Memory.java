//interfaccia grafica e gestione del memory e della classifica
...
class GUI_Memory extends JFrame implements ActionListener,ItemListener {
	...
	public GUI_Memory(String titolo){
		...
		testoIstruzione.setText("<html> Le regole del Memory sono molto semplici."
			...
			+"se queste hanno la stessa immagine rimaranno scoperte e si sottraranno all'ammontare delle coppie ancora da ricercare," 
			...
			+"<br>Nella parte centrale ci sara' il gioco vero e proprio."
			...
			while((riga=fInBfr.readLine()) != null) {
				try{
					...
					JOptionPane.showMessageDialog(null,"file contenente la classifica del livello "+livello+" corrotto."
									...
									+"\noppure ritrova l'errore manualmente il formato corretto e' (il nome non puo' essere vuoto):"
									+"\nnome1;01:23.456\nnome2;01:23.456");
					System.exit(1);			
				}
